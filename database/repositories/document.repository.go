...
type DocumentRepositoryInterface interface {
	...
	Show(documentId string) (models.Document, error)
...
func (repo *DocumentRepository) Show(documentId string) (models.Document, error) {
	var document models.Document

	result := repo.DB.First(&document, "id = ?", documentId)
